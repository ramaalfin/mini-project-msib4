                        ...
                        <div class="col-lg-12 mb-4 order-0">
                            <div class="card">
                                <div class="d-flex align-items-end row">
                                    <div class="col-sm-12">
                                        <div class="card-body">
                                            <h5 class="card-title text-primary ms-2">Tambah Kartu</h5>
                                            <form action="controller.php" method="POST">
                                                <div class="p-2">
                                                    <div class="row">
                                                        <div class="col mb-3">
                                                            <label for="kode" class="form-label">Kode Kartu (Maks. 6 karakter)</label>
                                                            <input type="text" id="kode" class="form-control" name="kode" placeholder="Kode" maxlength="6" required>
                                                        </div>
                                                    </div>
                                                    <div class="row">
                                                        <div class="col mb-3">
                                                    ...
                                                    <div class="row">
                                                        <div class="col mb-3">
                                                            ...
                                                            <input type="number" step="any" id="diskon" class="form-control" name="diskon" placeholder="diskon" required>
                                                        </div>
                                                    </div>
                                                    <div class="row">
                                                        <div class="col mb-3">
                                                            <label for="iuran" class="form-label">Iuran (Rp)</label>
                                                            <input type="number" id="iuran" class="form-control" name="iuran" placeholder="iuran" required>
                                                        </div>
                                                    </div>
